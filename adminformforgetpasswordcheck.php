...
if(isset($_GET['taken'])){
    ...
    if(isset($_POST['resetpass']))
    {
        ...
        if($pass===$cpass){
            ...
            $cpass=$pass;
            $sql="UPDATE admin SET password='$pass',cpassword='$cpass' WHERE token='$token'";
            ...
            if($res){
                        ...
                        ?>
<script> alert("password write wrong")</script>
                        <?php
...
if(isset($_SESSION['last_time_here'])){

    if((time()-$_SESSION['last_time_here'])>30){
        $_SESSION['message']="<div class='chip red black-text'>you lose time again forget password</div>";
        header("Location:adminsignin.php");
    }else{
